...
Function: getWinRanks($players)
Accepts array of players and ranks them in wrank.  
Returns the player array with wranks added

Function: getEffRanks($players)
Accepts array of players and ranks them in erank.  
Returns the player array with eranks added
*/
...
function getEffRanks($wrankedPlayers){
	//generate erank
